function Card(props){
    ...
    return(
        <div className={`text-white shadow  rounded-2xl shadow-black p-5 ${largura ? 'w-full max-w-56' : 'w-80'} ${largura ? 'h-4/5' : ''} hover:scale-105 transition-all hover:bg-cyan-500 hover:text-blue-950`}>
