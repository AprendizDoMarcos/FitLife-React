    ...
    return(
        <div className="flex flex-col items-center border-b border-cyan-400 border-dashed border-r w-60 sm:w-80">
            ...
            <svg className="w-44 aspect-square rotate-90">
                ...
                <circle r="70" cy="90" cx="90" className="fill-none stroke-white animate-progresss" style={{strokeWidth: 0.4 + "em",strokeDasharray: 440, strokeDashoffset: 440*props.por-440,strokeLinecap: 'round'}}></circle>
            </svg>
