            ...
            <ul className='flex flex-col items-center gap-3'>
                {Itens.map(item =>
                    <li key={item.texto} className='border-dashed border-b border-cyan-400 w-4/5 hover:scale-125 transition-all'>
                        <a href="" className='w-full h-full flex items-center gap-2 hover:bg-cyan-400 hover:text-blue-950 p-2 transition-all'>
                            <img className='grayscale w-10' src={item.img} alt={item.alt} />
